    ...
    <div class="max-w-screen-xl mx-auto">
        ...
        <div>
            <div class="ml-[80px] mt-[50px] absolute w-[75%] h-[100px] pb-8 bg-gray-100 rounded-[18px] shadow-l">
                ...
                <button type="button" class="absolute ml-[900px] mt-[-30px] text-white bg-[#69A197] hover:bg-[#69A197] focus:ring-4 focus:ring-[#69A197] font-medium rounded-lg text-sm px-5 py-2 me-2 mb-2 dark:bg-[#69A197] dark:hover:bg-[#69A197] focus:outline-none dark:focus:ring-[#69A197]"><a href="{{ route('incomplete') }}">Give rating</a></button>
            </div>
        ...
        <div class="ml-[60px] mt-[60px] absolute w-[250px] h-[290px] pb-8 bg-gray-100 rounded-[18px] shadow-l">
            <img src="{{ asset('assets/order1.png') }}">
        </div>
        <div class="ml-[360px] mt-[60px] absolute w-[250px] h-[290px] pb-8 bg-gray-100 rounded-[18px] shadow-l">
            <img src="{{ asset('assets/order2.png') }}">
        </div>
        <div class="ml-[660px] mt-[60px] absolute w-[250px] h-[290px] pb-8 bg-gray-100 rounded-[18px] shadow-l">
            <img src="{{ asset('assets/order3.png') }}">
        </div>
        <div class="ml-[960px] mt-[60px] absolute w-[250px] h-[290px] pb-8 bg-gray-100 rounded-[18px] shadow-l">
            <img src="{{ asset('assets/order1.png') }}">
        </div>
    </div>
@endsection
