...
@section('content')
            ...
            @if ($products)
                                    ...
                                    <div class="mt-12">
                                        <div class="flex flex-cols items-center">
                                            ...
                                            <div class="w-full text-right">
                                                ...
                                                <p class="text-xl font-semibold" id="totalPrice">Rp
                ...
                <div class="w-full">
                    ...
                    <button type="button"
                        ...
                        <a href="custCheckout" class="text-[20px]">Checkout</a>
                    </button>
                    <br>
                </div>
            @endif
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let pricePerUnit = parseInt(basePrice.value.replace("Rp ", "")); // Example price per unit
            ...
            function updateTotalPrice() {
                ...
                // Update subtotal and total cost based on total price
                const subtotal = totalPrice;
                const shippingCost = 15000; // Example shipping cost
